...
| Project | Description |
|--------|-------------|
| [Superstore Annual Sales — Exploratory Data Analysis](https://github.com/hassanab1/Superstore-Annual-Sales-Exploratory-Data-Analysis) | An end-to-end EDA project analyzing annual sales data from a fictional superstore to uncover trends in sales performance, profitability, and regional behavior. |
